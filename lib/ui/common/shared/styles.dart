...
const greenShade1 = Color(0xFF00BE93);
const onGoing = Color(0xFF01B8F9);
...
const continueButton = Color(0xFF2B5CFF);
const pendingColor = Color(0xFFFEBB24);
const pending = Color(0xFFFFA500);
const monthlyProjects = Color(0xFF2B5CFF);
...
const publisButtonColor = Color(0xFF01B8F9);
const cardColor = Color(0xFF00BE93);
const subText = Color(0xFF095299);
...
const appGreen400 = Color(0xFF00BE93);
