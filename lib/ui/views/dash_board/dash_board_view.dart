  ...
  Widget builder(
    ...
    return Scaffold(
      ...
      body: PermissionHelper.instance.canView('dashboard')
          ? viewModel.isBusy && viewModel.dashboardData == null
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Wrap(
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: () =>
                                    viewModel.exportPdfWeb(context),
                                icon:
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      final int initialYear = int.tryParse(
                        ...
                        _buildSectionHeader(
                            'Influencers Count (${formatNumber(viewModel.totalInfluencersCount)})'),
                        Wrap(
                          spacing: 16,
                          runSpacing: 16,
                          children: [
                            _buildPremiumMetricCard(
                              ...
                              title: 'Influencers',
                              count: formatNumber(
                                  viewModel.regularInfluencersCount),
                              color: continueButton,
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _buildPremiumMetricCard(
                              ...
                              count: formatNumber(
                                  viewModel.regularInfluencerProjects),
                              color: activeColor,
                          ...
                          children: [
                            _buildPremiumMetricCard(
                              ...
                              count: formatCurrency(
                                  viewModel.clientProjectCommission),
                              color: appGreen600,
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _buildPremiumMetricCard(
                              ...
                              count: formatNumber(
                                  viewModel.packageInfluencerCount),
                              color: red,
                              icon: Icons.campaign_outlined,
                            ),
                            // _buildPremiumMetricCard(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ClientProjectInfoCard(
                                          boxColor: greenShade1.withValues(
                                              alpha: 0.10),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ClientProjectInfoCard(
                                          boxColor: appGreen400.withValues(
                                              alpha: 0.10),
