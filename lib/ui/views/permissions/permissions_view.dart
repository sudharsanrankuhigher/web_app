                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              //   ),
                              // ),
                              (viewModel.isPermissionsLoading == false)
                                  ? Column(
                                      children: [
                                        verticalSpacing12,
                    ...
                    child: Row(
                      ...
                      children: [
                        CommonButton(
                          width: 100,
                          padding:
                              defaultPadding4 + leftPadding4 + rightPadding4,
                          height: 45,
                          text: 'Cancel',
                          buttonColor: red,
                          textStyle: fontFamilyBold.size14.white,
                          onTap: () {
                            viewModel.setSelectedRoleId(null);
                            viewModel.syncUiWithPermissions();
                          },
                        ),
                        CommonButton(
                          width: 100,
                          ...
                          onTap: () {
                            viewModel
                                .getAllPermissions(viewModel.selectedRoleId);
                          },
                        ),
                        CommonButton(
                          width: 100,
